---
title: "Substack vs Beehiiv vs ConvertKit: What You Actually Keep"
description: "Substack's cut scales with your revenue; Beehiiv's flat monthly fee does not. See where the lines cross for your subscriber count, plus sponsorship CPM math."
publishedDate: 2026-01-26
category: creator
calculatorSlugs:
  - /creator/substack-calculator
  - /creator/newsletter-revenue-calculator
---
...
| | Substack | Beehiiv (Scale) | ConvertKit |
|---|---|---|---|
...
| **Effective rate** | **15.9%** | **10.85%** | **11.85%** |
...
The right platform depends on your specific subscriber count, price point, growth rate, and revenue mix. General comparisons only go so far. Use our [Substack calculator](/creator/substack-calculator) to model your paid subscription revenue after Substack's fees, or our [newsletter revenue calculator](/creator/newsletter-revenue-calculator) to compare subscription plus sponsorship income across platforms with churn and growth projections built in. Plug in your actual numbers and see what you keep.
