...
This article walks through rideshare driver earnings with real math — how pay actually works, what your car costs you, and what lands in your bank account after everything. You can also run your own numbers with our [Uber/Lyft Calculator](/gig-economy/uber-lyft-calculator), which factors in your specific vehicle, mileage, and expenses.
...
The catch is the same one that applies to [DoorDash challenges](/blog/doordash-driver-earnings): chasing a quest can push you to accept low-paying short rides just to hit the count, which may actually lower your per-hour earnings when you factor in vehicle costs for each trip.
...
If you drive rideshare regularly, you should also be making [quarterly estimated tax payments](/blog/quarterly-tax-guide-freelancers) to avoid underpayment penalties. The IRS expects self-employed individuals to pay taxes four times per year, not once in April.
