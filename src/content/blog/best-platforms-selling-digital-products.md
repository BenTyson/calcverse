...
category: creator
calculatorSlugs:
  - /creator/gumroad-calculator
  - /creator/print-on-demand-profit-calculator
  - /creator/online-course-revenue-calculator
---
...
Refund rates on digital products run 2 to 5 percent on average. Gumroad handles refunds automatically and deducts the refunded amount (including fees) from your balance. Our [Gumroad calculator](/creator/gumroad-calculator) factors in refund rates and affiliate commissions to show your true net revenue.
...
The [print-on-demand calculator](/creator/print-on-demand-profit-calculator) models all three platforms (Printful, Printify, Merch by Amazon) and three marketplace options (Etsy, Amazon, own store) so you can compare the actual per-unit profit across combinations.

### Realistic POD income

The median POD seller earns less than $500 per month. The ones who earn $2,000 or more per month typically have 10 or more active designs, sell across multiple product types (not just t-shirts), and invest in paid advertising or have an organic traffic source.
...
The [online course calculator](/creator/online-course-revenue-calculator) models all four platform types and includes subscription revenue and launch cohort pricing, so you can see the full picture for multi-stream course businesses.
...
Before you commit to a platform, run your actual numbers. Use the [Gumroad calculator](/creator/gumroad-calculator) for direct digital sales, the [print-on-demand calculator](/creator/print-on-demand-profit-calculator) for physical products, and the [online course calculator](/creator/online-course-revenue-calculator) for educational content. The right platform is the one where the math works for your specific product, price point, and traffic source.
